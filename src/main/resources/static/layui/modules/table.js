...
;layui.define(["laytpl", "laypage", "layer", "form"], function (e) {
    ...
    S.prototype.config = {
        ...
        if (a.elem = t(a.elem), a.where = Object.assign(a.where,{ACCESS_TOKEN: layui.data('zhsf').ACCESS_TOKEN}) || {ACCESS_TOKEN: layui.data('zhsf').ACCESS_TOKEN}, a.id = a.id || a.elem.attr("id"), a.request = t.extend({
            pageName: "page",
            limitName: "limit"
